...
源 APK 已作为发布包上传（调试签名，仅供测试预览）：

[**⬇ 下载 lazyalarm-v1.1.12-preview.apk**](https://github.com/744219288/lazyalarm-preview-analysis/releases/download/v1.1.12-preview/lazyalarm-v1.1.12-preview.apk)（14.95 MB · SHA-256 `97df9a69...15592`）
